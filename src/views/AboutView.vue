      ...
      <div class="container px-5 mx-auto">
        ...
        <div class="flex flex-wrap -m-2">
          <div class="p-2 lg:w-1/3 md:w-1/2 w-full">
            <div class="h-full flex items-center dark:border-gray-800 hover:bparent border shadow-xl p-4 rounded-2xl hover:scale-105 duration-100 dark:bg-[#1c1c2e]">
          ...
          <div class="p-2 lg:w-1/3 md:w-1/2 w-full">
            <div class="h-full flex items-center dark:border-gray-800 hover:bparent border shadow-xl p-4 rounded-2xl hover:scale-105 duration-100 dark:bg-[#1c1c2e]">
              ...
              <div class="flex-grow">
                <h2 class="dark:text-gray-200 title-font font-medium">Ian Rachman</h2>
          ...
          <div class="p-2 lg:w-1/3 md:w-1/2 w-full">
            <div class="h-full flex items-center dark:border-gray-800 hover:bparent border shadow-xl p-4 rounded-2xl hover:scale-105 duration-100 dark:bg-[#1c1c2e]">
              ...
              <div class="flex-grow">
                <h2 class="dark:text-gray-200 title-font font-medium">Abdul Majid</h2>
                <p class="text-gray-500">Member</p>
              </div>
            </div>
          </div>
          <div class="p-2 lg:w-1/3 md:w-1/2 w-full">
            <div class="h-full flex items-center dark:border-gray-800 hover:bparent border shadow-xl p-4 rounded-2xl hover:scale-105 duration-100 dark:bg-[#1c1c2e]">
              ...
              <div class="flex-grow">
                <h2 class="dark:text-gray-200 title-font font-medium">Rafa Rajendra</h2>
                <p class="text-gray-500">Member</p>
              </div>
            </div>
          </div>
          <div class="p-2 lg:w-1/3 md:w-1/2 w-full">
            <div class="h-full flex items-center dark:border-gray-800 hover:bparent border shadow-xl p-4 rounded-2xl hover:scale-105 duration-100 dark:bg-[#1c1c2e]">
              ...
              <div class="flex-grow">
                <h2 class="dark:text-gray-200 title-font font-medium">hidzkul Hisyam</h2>
                <p class="text-gray-500">Member</p>
              </div>
            </div>
          </div>
      ...
      <div class="viewFooter mt-10 xl:mt-52 dm_sans">
        ...
        <div class="ClassName flex justify-center mt-10">
          <button class="p-3 bg-blue-500 text-center md:block lg:block xl:block hover:bg-blue-600 duration-100 hover:scale-95 hover:shadow-md hover:shadow-sky-400 rounded-full">
            <a class="dark:text-gray-200 text-gray-200 text-sm text-center font-medium" href="#header-about">back to up</a>
          </button>
        </div>
