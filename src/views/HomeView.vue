...
<template>
    ...
    <div class=" dark:bg-[#1c1c2e] h-52 rounded-3xl mx-auto mt-5">
      ...
      <div class="grid grid-cols-2 gap-8 md:grid-cols-6 lg:grid-cols-5">
        <div class="flex items-center justify-center col-span-1 md:col-span-2 lg:col-span-1">
          <svg class="h-12 text-gray-500 fill-current dark:text-gray-300" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 266 100">
        ...
        <div class="flex items-center justify-center col-span-1 md:col-span-2 lg:col-span-1">
          <svg class="h-10 text-gray-500 fill-current dark:text-gray-300" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 316 60">
        ...
        <div class="flex items-center justify-center col-span-1 md:col-span-2 lg:col-span-1">
          <svg class="h-8 mt-2 text-gray-500 fill-current dark:text-gray-300" viewBox="0 0 398 120" xmlns="http://www.w3.org/2000/svg">
            <g fill-rule="nonzero">
        ...
        <div class="flex items-center justify-center col-span-2 md:col-span-3 lg:col-span-1">
          <svg class="h-8 text-gray-500 fill-current dark:text-gray-300" viewBox="0 0 2270 546" xmlns="http://www.w3.org/2000/svg">
            <g fill-rule="evenodd">
              <path
  ...
  <div class="xl:mt-5">
    <div class="flex flex_responsive_parallax justify-center">
      ...
      <div class="p-4 m-2 parallax2 rounded-3xl sm:w-1/2 shadow-xl lg:w-full dark:bg-[#1c1c2e]">
        <paralax2 />
      </div>
    </div>
            ...
            <div class="ClassName">
              <form action="https://api.web3forms.com/submit" method="POST" class="grid gap-4 max-w-8xl mx-auto rounded-lg w-full">
                ...
                <div class="gap-3 flex">
                  <input type="text" name="name" required placeholder="Your Name" class="w-full p-5 rounded-2xl mt-3 shadow-lg dark:shadow-gray-900 focus:outline-none bg-transparent focus:border-blue-500 bg-[#1c1c2e] text-white" />
