<template>
  ...
  <div class="mt-5">
    ...
    <div class="viewFooter mt-52 dm_sans">
      ...
      <p class="text-center desk_footer mt-5 xl:w-1/3 mx-auto dark:text-gray-300 text-sm leading-8">terimakasih telah berkunjung Di Website kami Nusantara Developer. Kami sangat senang Dengan Kehadiran Anda di website ini. semoga menginspirasikan Kalian Semua.</p>
